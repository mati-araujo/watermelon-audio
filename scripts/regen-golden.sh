...
WMA_GOLDEN_REGEN=1 bash "$REPO_ROOT/scripts/run-cpp-tests.sh" -R 'GoldenPresets|GoldenPhaseSlope|GoldenStrobe|GoldenInharmonicity|GoldenIntonation|GoldenFastMode' "$@"
